      ...
      computed:{
        ...
        filterRatings(){
          ...
          return ratings.filter(rating=>{
            ...
            //如果下面的为真就返回一个过滤后的数组 这是个评价模块，selectType=2的话就是全选 0是满意 1是不满意  rateType是评价的一个属性  说明是满意还是不满意    onlyShowText表示是否显示有文本的 初始值为true   然后后面的text就是评价的  长度是否大于0
          })
        }
      },
      mounted(){
